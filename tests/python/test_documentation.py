...
def test_release_documentation_and_licenses_are_present() -> None:
    expected = (
        ...
        "LICENSE-CONTENT.md",
        "assets/SOURCES.md",
        "docs/superpowers/specs/2026-07-28-lab-001-perspective-paste-design.md",
        "docs/superpowers/plans/2026-07-28-lab-001-perspective-paste-implementation.md",
    )
...
def test_asset_ledger_records_all_six_examples() -> None:
