...
export function exportCalibration(result){return JSON.stringify({...result,schema:CONTRACTS.calibrationSchema,version:1,intrinsics:result.intrinsics,metrics:result.metrics});}
